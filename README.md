[![Build Status](https://travis-ci.org/hortonworks-spark/spark-atlas-connector.svg?branch=branch-2.4)](https://travis-ci.org/hortonworks-spark/spark-atlas-connector)
